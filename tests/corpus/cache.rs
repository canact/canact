...
#[test]
fn cache_key_format_is_model_provider_unset_v71() {
    assert_eq!(PROBE_SUITE_VERSION, 71);
    ...
    assert_eq!(k, "model|provider|unset|v71|full|novision|ctxnone");
}
...
fn get_misses_when_suite_differs() {
    ...
    assert!(
        cache
            ...
            .is_none(),
        "suite v71 must not hit v6 cache entry"
    );
}
